		...
		this.getDom = function(path, name, partnerDom) {
			...
			if(ImagesMap[path]) {
				if(name) {
					...
					var width = getPro(partnerDom, "width");
					var height = getPro(partnerDom, "height");
	...
	for(var i = 0, len = 2; i < len; i++) {
		Images.loadRequire("./system/system"+(i+1) + ".png", "system"+(i+1)+".png");
	}
